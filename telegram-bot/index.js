...
function buildWelcome(lang) {
  const base = lang === 'ru'
    ? [
        ...
        '',
        'Кто мы и что делаем:',
        '• AI‑ассистенты, которые продают, отвечают и записывают клиентов 24/7',
        '• Собираем заявки из Instagram/сайта/мессенджеров в один поток',
        '• Убираем хаос и ручную переписку',
        '',
        'Что получишь в итоге:',
        '• Меньше пропущенных клиентов',
        '• Быстрее ответы и понятный статус каждой заявки',
        '• Запуск за 3–7 дней (пилот), сложные кейсы 10–14 дней',
        '',
        'Доказательства/пруфы:',
        '• Покажу кейсы и сценарий под твой бизнес',
        '• Цены прозрачные, без “скрытых работ”',
        '',
        'Выбери язык общения:',
      ]
    : [
