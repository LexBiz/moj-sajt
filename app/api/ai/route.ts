...
function buildContext({ businessType, channel, pain, lang, mode }: AiRequest) {
  ...
  return [
    ...
    langLine,
    lng === 'ru'
      ? 'Система уже настроена и работает. Пиши живо и конкретно, как сильный менеджер. Эмодзи можно, но уместно и немного.'
      : lng === 'cz'
      ? 'Systém už je nastavený a běží. Piš živě a konkrétně, jako silný manažer. Emojis jen málo a rozumně.'
