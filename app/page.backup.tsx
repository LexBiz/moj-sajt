      ...
      <header className="sticky top-0 z-50 backdrop-blur-lg bg-slate-900/80 border-b border-slate-700/50 shadow-sm">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between gap-3 sm:gap-4">
          ...
          <div className="flex items-center gap-2 sm:gap-4 shrink-0">
            ...
            <a
              href="/flow"
              className="hidden sm:inline-flex items-center justify-center rounded-full bg-white/10 border border-indigo-400/40 px-4 py-2 text-sm font-semibold text-white hover:bg-white/15 transition-all shadow-md"
            >
              ⚡ Замовити систему
            </a>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <div className="mt-8 sm:mt-10 flex flex-col sm:flex-row gap-3 sm:gap-4">
                <a
                  href="/flow"
                  className="shine inline-flex items-center justify-center rounded-full bg-gradient-to-r from-indigo-500 to-purple-500 px-7 sm:px-9 py-3.5 sm:py-4 text-base sm:text-lg font-semibold text-white hover:from-indigo-600 hover:to-purple-600 transition-all shadow-xl hover:shadow-2xl hover:scale-105 text-center"
                >
                  ⚡ Замовити систему
                </a>
                <a
                  href="/flow"
                  className="inline-flex items-center justify-center rounded-full border-2 border-white/15 bg-white/10 px-7 sm:px-9 py-3.5 sm:py-4 text-base sm:text-lg font-semibold text-white hover:bg-white/15 transition-all shadow-lg hover:shadow-xl text-center"
                >
                  👀 Демо: як це працює у твоєму бізнесі
                </a>
              </div>
            </div>
