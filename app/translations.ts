export const translations = {
  ru: {
    ...
    heroTitle: "Превращаю бизнес‑задачи в работающие решения",
    heroDesc: "Без лишней сложности и «чёрного ящика». Вы говорите, что должно измениться — я делаю так, чтобы это произошло.",
    projects: "Проектов",
    satisfied: "Довольных",
    yearsExp: "Лет опыта",
    ...
    problem1Desc: "но вас заставляют принимать решения в непонятных терминах.",
    problem2: "Слишком много сложности",
    problem2Desc: "сроки «плывут», задачи размываются, результат непредсказуем.",
    problem3: "Сайт есть, но не работает на деньги",
    problem3Desc: "нет заявок, нет контроля, нет понятного следующего шага.",
    solution: "Я говорю на языке бизнеса, а не технологий",
    solution2: "Фиксированные сроки и цены с первого дня",
    solution3: "Создаю решения, которые приносят результат",
    ...
    simpleWebsite: "Веб-визитка",
    simpleWebsiteDesc: "Короткий сайт «кто вы / что делаете / как связаться». Чтобы вас можно было быстро понять и выбрать.",
    landingPage: "Лендинг",
    landingPageDesc: "Продающая страница под конкретную услугу. С ясным предложением и призывом к действию.",
    telegramBots: "Telegram бот",
    telegramBotsDesc: "Бот, который отвечает, собирает заявки, ведёт по шагам и разгружает команду.",
    crmAuto: "CRM и автоматизация",
    crmAutoDesc: "Порядок в работе с клиентами: меньше рутины, больше контроля, меньше потерь.",
    complexAI: "Комплексные решения",
    complexAIDesc: "Когда нужно связать несколько частей бизнеса и ускорить работу «умными» сценариями — без шума и модных слов.",
    
    // New Packages
    packageStandard: "Пакет Standard",
    packageStandardDesc: "Веб-сайт / лендинг • Форма заявок • Telegram-бот для уведомлений • Настройка оплаты или календаря",
    packagePro: "Пакет Pro",
    packageProDesc: "Всё из Standard + Автоматизация CRM / Google Sheets • Email / Telegram рассылка • Поддержка 1 месяц",
    packagePremium: "Пакет Premium",
    packagePremiumDesc: "Всё из Pro + Индивидуальный дизайн • Доп. интеграции (оплата, Google Ads) • Поддержка 3 месяца",
    ...
    // Trust
    trustTitle: "Почему со мной спокойно",
    
    // Process
    processTitle: "Процесс: от идеи до результата",
    
    // Trust cards
    howIThink: "Как я думаю",
    howIThinkDesc: "Деньги, время и риски важнее «идеальной реализации».",
    ...
    honestyDesc: "Если задача не даст эффекта — скажу до старта.",
    ...
    // Cases
    businessConsultant: "Boss Detaling — Полный пакет",
    businessConsultantDesc: "Сайт премиум детейлинга авто + Telegram-бот для записи. Пример выполненного пакета: клиент получил всё под ключ.",
    conversionRate: "Онлайн-запись",
    requestsPerMonth: "Заявок через бот/мес",
    devTime: "Срок разработки",
    days: "дней",
    eduPlatform: "Sphynx Dubai — Питомник кошек",
    eduPlatformDesc: "Премиум сайт для питомника кошек породы Сфинкс в Дубае с онлайн-записью и галереей котят.",
    timeSaved: "Скорость загрузки",
    autoReplies: "Посетителей/месяц",
    happyClients: "Конверсия в контакт",
    onlineStore: "TikTok Boost Lana",
    onlineStoreDesc: "Сервис продвижения в TikTok с автоматизацией заявок и аналитикой роста аккаунтов клиентов.",
    processingSpeed: "Прирост заявок",
    errors: "Новых клиентов",
    roi: "Срок окупаемости",
    months: "месяца",
    legalCompany: "Anika Brand Lux — E-commerce",
    legalCompanyDesc: "Интернет-магазин люксовых брендовых товаров с корзиной, онлайн-оплатой и системой управления заказами.",
    ...
    readyDesc: "Опишите задачу простыми словами: что хотите улучшить и какой результат нужен. Я задам несколько вопросов и предложу понятный следующий шаг.",
    writeEmail: "Написать на почту",
    writeTelegram: "Написать в Telegram",
    writeWhatsapp: "Написать в WhatsApp",
    respondFast: "Отвечаю быстро",
    freeConsult: "Первая консультация",
    untilAgree: "Пока не договоримся",
  ...
  ua: {
    ...
    heroTitle: "Перетворюю бізнес‑задачі у працюючі рішення",
    heroDesc: "Без зайвої складності та «чорної скриньки». Ви говорите, що має змінитися — я роблю так, щоб це сталося.",
    projects: "Проектів",
    ...
    simpleWebsite: "Веб-візитка",
    simpleWebsiteDesc: "Короткий сайт «хто ви / що робите / як зв'язатися». Щоб вас можна було швидко зрозуміти і обрати.",
    landingPage: "Лендінг",
    landingPageDesc: "Продаюча сторінка під конкретну послугу. З ясною пропозицією та закликом до дії.",
    telegramBots: "Telegram бот",
    telegramBotsDesc: "Бот, який відповідає, збирає заявки, веде по крокам і розвантажує команду.",
    crmAuto: "CRM та автоматизація",
    crmAutoDesc: "Порядок у роботі з клієнтами: менше рутини, більше контролю, менше втрат.",
    complexAI: "Комплексні рішення",
    complexAIDesc: "Коли потрібно зв'язати кілька частин бізнесу та прискорити роботу «розумними» сценаріями — без шуму та модних слів.",
    
    // New Packages
    packageStandard: "Пакет Standard",
    packageStandardDesc: "Веб-сайт / лендінг • Форма заявок • Telegram-бот для повідомлень • Налаштування оплати або календаря",
    packagePro: "Пакет Pro",
    packageProDesc: "Все з Standard + Автоматизація CRM / Google Sheets • Email / Telegram розсилка • Підтримка 1 місяць",
    packagePremium: "Пакет Premium",
    packagePremiumDesc: "Все з Pro + Індивідуальний дизайн • Додаткові інтеграції (оплата, Google Ads) • Підтримка 3 місяці",
  ...
  en: {
    ...
    heroTitle: "I turn business tasks into working solutions",
    heroDesc: "No unnecessary complexity or 'black box'. You say what needs to change — I make it happen.",
    projects: "Projects",
    satisfied: "Satisfied",
    yearsExp: "Years exp",
    ...
    simpleWebsite: "Business card site",
    simpleWebsiteDesc: "A short website 'who you are / what you do / how to contact'. So you can be quickly understood and chosen.",
    landingPage: "Landing page",
    landingPageDesc: "A selling page for a specific service. With a clear offer and call to action.",
    telegramBots: "Telegram bot",
    telegramBotsDesc: "A bot that answers, collects requests, guides step by step and unloads the team.",
    crmAuto: "CRM & Automation",
    crmAutoDesc: "Order in working with clients: less routine, more control, fewer losses.",
    complexAI: "Complex solutions",
    complexAIDesc: "When you need to connect several parts of the business and speed up work with 'smart' scenarios — without noise and buzzwords.",
    
    // New Packages
    packageStandard: "Standard Package",
    packageStandardDesc: "Website / Landing • Request form • Telegram bot for notifications • Payment or calendar setup",
    packagePro: "Pro Package",
    packageProDesc: "All from Standard + CRM / Google Sheets automation • Email / Telegram newsletter • 1 month support",
    packagePremium: "Premium Package",
    packagePremiumDesc: "All from Pro + Custom design • Additional integrations (payment, Google Ads) • 3 months support",
